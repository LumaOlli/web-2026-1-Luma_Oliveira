  ...
  return (
    <div className="app-layout">
      ...
      <main className="app-content service-page">
        {/* PADRONIZAÇÃO: Substituímos o <header> manual pelo componente oficial */}
        <Header titulo="Monitoria Acadêmica" />
...
/* --- ÍCONES (Apenas os necessários para o corpo da página) --- */
...
function CalendarCheckIcon() { return <IconBase><rect x="3" y="5" width="18" height="16" rx="2" /><path d="M16 3v4M8 3v4M3 10h18" /><path d="m9 16 2 2 4-5" /></IconBase>; }
function AlertCircleIcon() { return <IconBase><circle cx="12" cy="12" r="9" /><path d="M12 8v5" /><path d="M12 16h.01" /></IconBase>; }
function SummaryIcon() { return <IconBase><path d="M4 7h16M4 12h12M4 17h10" /><path d="m17 15 2 2 3-4" /></IconBase>; }
function ObservationIcon() { return <IconBase><circle cx="9" cy="9" r="3" /><path d="M4 20a6 6 0 0 1 10 0" /><path d="m14 13 6-6" /><path d="m15 7 2 2" /></IconBase>; }
function CheckCircleIcon() { return <IconBase><circle cx="12" cy="12" r="9" /><path d="m8 12 3 3 5-6" /></IconBase>; }
